			...
			<div className="w-full bg-gradient-to-r from-purple-900/90 via-slate-900/95 to-purple-900/90 border-b border-purple-500/50 rounded-lg">
				<div className="container mx-auto px-4 py-4">
					<div className="flex flex-col items-center justify-center gap-4">
						<span className="font-semibold text-slate-200">{t('pages:home:officialContracts:title')}</span>
						<div className="flex flex-col md:flex-row gap-6 w-full max-w-4xl">
							<div className="flex-1 bg-slate-900/50 p-4 border border-purple-500/30 hover:border-purple-500/50 transition-all rounded-lg">
								<div className="flex flex-col md:flex-row items-center justify-between gap-4">
									<div className="flex flex-col gap-1">
										<span className="text-purple-400 font-semibold">{t('pages:home:officialContracts:ofd:title')}</span>
							...
							<div className="flex-1 bg-slate-900/50 p-4 border border-purple-500/30 hover:border-purple-500/50 transition-all rounded-lg">
								<div className="flex flex-col md:flex-row items-center justify-between gap-4">
									<div className="flex flex-col gap-1">
										<span className="text-purple-400 font-semibold">{t('pages:home:officialContracts:ofdps:title')}</span>
