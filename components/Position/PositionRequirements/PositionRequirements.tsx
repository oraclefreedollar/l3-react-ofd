        ...
        <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-gradient-to-br from-purple-900/90 to-slate-900/95 backdrop-blur-md rounded-lg p-6 h-64">
                    ...
                    <p className="text-gray-300">
                        At least 5,000 OFD worth of collateral is needed to secure your position.
                        This collateral acts as security for the amount you&apos;ll mint, allowing you to leverage your assets safely.
                    </p>
                </div>
            </div>
        </div>
