	...
	return (
		<div className="bg-gradient-to-br from-purple-900/90 to-slate-900/95 backdrop-blur-md rounded-xl p-8 flex flex-col border border-purple-500/50">
			...
			<div className="space-y-2">
				...
				<SummaryRow label="Initialization Period" value={`${form.initPeriod.toString()} days`} />
				...
				<SummaryRow label="Annual Interest Rate" value={formatPercentage(form.interest)} />

				<SummaryRow label="Maturity Period" value={`${form.maturity.toString()} days`} />
				...
				<SummaryRow label="Retained Reserve" value={formatPercentage(form.buffer)} />

				<SummaryRow label="Auction Duration" value={`${form.auctionDuration.toString()} hours`} />
			</div>
