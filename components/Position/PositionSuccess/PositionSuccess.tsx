            ...
            <div className="relative bg-gray-800 rounded-xl p-8 max-w-md w-full mx-4 shadow-2xl border border-gray-700 transform transition-all duration-300 ease-out scale-100 opacity-100">
                <div className="flex flex-col items-center text-center">
                    ...
                    <h3 className="text-2xl font-bold text-white mb-3">
                        Position Successfully Proposed!
                    </h3>

                    <p className="text-gray-300 mb-6">
                        Your position has been created and is now pending approval by governance.
                    </p>

                    <p className="text-gray-300 mb-6">
                        After approval you can convert your OFD into OFDPS and actively participate in the protocol.
                    </p>
