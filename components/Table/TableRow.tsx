...
export default function TableRow({ colSpan, children, actionCol, link }: Props) {
	return (
		<Link
			className={`bg-slate-800 hover:bg-slate-700 px-8 py-8 xl:px-16 first:border-t-0 sm:first:border-t border-t bg-gradient-to-br from-purple-900/50 to-slate-900/95 backdrop-blur-md border-purple-500/50 first:rounded-t-lg sm:first:rounded-t-none last:rounded-b-lg duration-300 ${
				link && 'cursor-pointer'
			}`}
			href={link || '#'}
		>
